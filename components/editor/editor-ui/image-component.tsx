...
function LazyImage({
  ...
  const imageStatus = status as { error: false; width: number; height: number };
  ...
  const calculateDimensions = () => {
    ...
    const naturalWidth = imageStatus.width;
    const naturalHeight = imageStatus.height;
...
export default function ImageComponent({
  ...
  }, [editor, $onEnter, $onEscape, onClick]);
