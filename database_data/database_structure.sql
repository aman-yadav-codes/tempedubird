...
CREATE TABLE "institution_news" (
	...
	"created_at" timestamp DEFAULT CURRENT_TIMESTAMP NOT NULL,
	"updated_at" timestamp DEFAULT CURRENT_TIMESTAMP NOT NULL,
	"target_type" varchar(30) DEFAULT 'WHOLE_INSTITUTION' NOT NULL,
	"target_role_code" varchar(20),
	"target_id" bigint,
	"target_program_id" bigint,
	"target_label" text,
	CONSTRAINT "chk_institution_news_target_role" CHECK (((target_role_code IS NULL) OR ((target_role_code)::text = ANY ((ARRAY['teacher'::character varying, 'student'::character varying])::text[])))),
	CONSTRAINT "chk_institution_news_target_type" CHECK (((target_type)::text = ANY ((ARRAY['WHOLE_INSTITUTION'::character varying, 'ROLE'::character varying, 'PROGRAM'::character varying, 'SECTION'::character varying, 'USER'::character varying])::text[]))),
...
CREATE INDEX "idx_institution_cutoffs_academic_year" ON "institution_cutoffs" ("academic_year_id");
...
CREATE INDEX "idx_institution_placements_program" ON "institution_placements" ("program_id");
...
ALTER TABLE "institution_cutoffs" ADD CONSTRAINT "fk_institution_cutoffs_academic_year" FOREIGN KEY ("academic_year_id") REFERENCES "academic_years"("id") ON DELETE SET NULL;
...
ALTER TABLE "institution_placements" ADD CONSTRAINT "fk_institution_placements_program" FOREIGN KEY ("program_id") REFERENCES "institution_programs"("id") ON DELETE SET NULL;
